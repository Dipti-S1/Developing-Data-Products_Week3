...
All STATS19 data (accident, casualties and vehicle tables) for 2012, from https://data.gov.uk/dataset/road-accidents-safety-data/resource/8ecee6ac-33fd-4f5b-8973-e900cc65d24a)

Road Safety - Accidents 2013, from https://data.gov.uk/dataset/road-accidents-safety-data/resource/ceb00cff-443d-4d43-b17a-ee13437e9564)

Then extract the `Accidents0514.csv` and `Accidents_2015.csv` files from the zip files in a subdirectory named `data`.

read data for 2012 and 2013 as data tables and keep only severity and date columns

accidents0512 <- fread("data/Accidents0512.csv", header = TRUE, sep = ",")

accidents0512 <- accidents0512 %>%

select(Accident_Severity, Date)

accidents13 <- fread("data/Accidents_2013.csv", header = TRUE, sep = ",")

accidents13 <- accidents13 %>%
